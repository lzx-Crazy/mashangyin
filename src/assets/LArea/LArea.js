        ...
        finish: function(e) {
            ...
            if( $(".timebox").find("em").length>0)
            {
            	if(countyText=="")
            	{
            		...
            		$("#city").attr("data-value",cityCode);
            	}else{
            		$(".timebox").find("em").html(countyText)
            	}
            	
            }else{
            	$(".timebox").find(".addr").html(provinceText + ' ' + cityText+ ' '+countyText);
            	$("#province").val(provinceCode);
            	$("#city").val(cityCode);
            	$("#area").val(countyCode);
            	
            	$("#province").attr("data-value",provinceText);
            	$("#city").attr("data-value",cityText);
            	$("#area").attr("data-value",countyText);
            }
